/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e441c6929a0fcac5978888044eadfda5)
...
declare namespace Cloudflare {
	interface Env {
		...
		POSTMARKS: DurableObjectNamespace<import("./src/index").Postmarks>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FROM_EMAIL" | "REPLY_TO_EMAIL" | "POSTMARK_SERVER_TOKEN">> {}
}
